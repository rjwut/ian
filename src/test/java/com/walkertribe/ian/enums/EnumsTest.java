...
public class EnumsTest {
	...
	static {
		...
		UPGRADE_ACTIVATION_CONSOLES.put(Upgrade.CETROCITE_CRYSTAL, Console.ENGINEERING);
		UPGRADE_ACTIVATION_CONSOLES.put(Upgrade.LATERAL_ARRAY, Console.SCIENCE);
		UPGRADE_ACTIVATION_CONSOLES.put(Upgrade.TAURON_FOCUSER, Console.WEAPONS);
		UPGRADE_ACTIVATION_CONSOLES.put(Upgrade.INFUSION_P_COIL, Console.HELM);
		UPGRADE_ACTIVATION_CONSOLES.put(Upgrade.CARPACTION_COIL, Console.WEAPONS);
